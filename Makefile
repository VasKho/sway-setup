...
SWAY_CONFIG_SRC := $(MAKEFILE_DIR)sway/config.d $(MAKEFILE_DIR)sway/definitions.d $(MAKEFILE_DIR)sway/scripts $(MAKEFILE_DIR)sway/themes $(MAKEFILE_DIR)sway/config
